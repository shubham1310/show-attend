...
class CaptioningSolver(object):
    ...
    def train(self, chunk=0):
        ...
        alphas, _, generated_boxes = self.model.build_sampler(max_len=6)
            ...
            for e in range(self.n_epochs):
                ...
                for i in range(n_iters_per_epoch):
                    ...
                    if (i + 1) % self.print_every == 0:
                        ...
                        print "Generated:\n",
                        for k in gen_bboxs[0]:
                            print "[%0.2f, %.2f]" %(k[0],k[1])
                        print "\n"
                ...
                if self.print_bleu and (e % 5 ==0):
                    all_gen_box = np.ndarray((n_iters_val*self.batch_size, 6,2))
                    alp=[]
                    for i in range(n_iters_val):
                        ...
                        alpha, gen_box = sess.run(
                            [alphas, generated_boxes],  feed_dict=feed_dict)
                    ...
                    for i in range(3):
                        ...
                        while j >= len(all_gen_box):
                            j=j/10
                        print "\nGround:\n",
                        for k in self.bbox[n_examples + j][1:]:
                            print "[%0.2f, %.2f]" %(k[0],k[1])
                        print '\n',
                        print "Generated:\n",
                        for k in all_gen_box[j]:
                            print "[%0.2f, %.2f]" %(k[0],k[1])
                        # print '\n'
                        # for k in range(6):
